...
export class Utils {
  ...
  static initializeSliderProduct() {
    setTimeout(function () {
      jQuery('#product-tab .featured_carousel_tab, #product-tab .latest_carousel_tab,' +
        ' #product-tab .bestseller_carousel_tab, #product-tab .special_carousel_tab').flexslider({
        animation: 'slide',
        animationLoop: false,
        slideshow: false,
        itemWidth: 210,
